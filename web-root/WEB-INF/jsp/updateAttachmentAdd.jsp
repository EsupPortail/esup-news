...
<fieldset><legend><fmt:message key="news.label.attachment.updateAFile.pageTitle" /></legend>
	...
	<table border="0" cellpadding="4" width="95%">
		<tr>
			...
			<td class="portlet-form-field-label">
				<html:input path="attachmentToUpdate.title" type="text" class="input"  size="69" maxlength="150" />
			</td>
		</tr>
		<tr>
			<td class="portlet-form-label"><fmt:message key="news.label.attachment.desc"/> : </td>
			<td class="portlet-form-field-label">
				<html:textarea path="attachmentToUpdate.desc" rows="3" cols="80" class="input" />
			</td>
		<tr>
			<td colspan="2" align="center">
				<!-- Buttons -->
				<input type="submit" name="_target0" value="<fmt:message key="button.update"/>"/>
