...
<c:out value='${entity.name}' /> </span> </legend>
<div class="texteBasPage">[<a href="${addEntityPermissionRenderUrl}"
...
<DL id="news_showhide">
	<DT onClick="slide('news_showhide_superUser')"><img src="<html:imagesPath/>fe.gif" alt="" /> <fmt:message
		key="news.label.superUsers" /> <img
		src="<html:imagesPath/>help_e.gif" align="absmiddle" alt="" /></DT>
