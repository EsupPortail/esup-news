...
<table border="0" cellspacing="0" cellpadding="4">
	<tr>
		...
		<td class="portlet-form-field-label"><c:out value='${entity.name}' />
			<html:input path="category.rssAllowed" value="1" type="hidden" />
			<html:input path="category.publicView" value="1" type="hidden" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<DL id="news_showhide">
			<DT onClick="slide('news_showhide_help_msg')"><span class="portlet-font"> <fmt:message
				...
				src="<html:imagesPath/>help_e.gif" align="absmiddle" alt="" /> </span>
