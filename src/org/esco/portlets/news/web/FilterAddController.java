 ...
 * 19 mai 2010
 */
public class FilterAddController extends SimpleFormController implements InitializingBean {

    /** Logger. */
    private static final Log LOG = LogFactory.getLog(FilterAddController.class);
   ...
   /* @Autowired
    ...
    protected Object formBackingObject(final PortletRequest request) throws Exception {
        ...
        Long entityId = PortletRequestUtils.getLongParameter(request, Constants.ATT_ENTITY_ID);
