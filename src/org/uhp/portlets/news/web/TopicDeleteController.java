...
public class TopicDeleteController extends AbstractController implements InitializingBean {
	...
	protected void handleActionRequestInternal(ActionRequest request, ActionResponse response) throws Exception {
		...
		if(!this.pm.isAdminInCtx(catId, NewsConstants.CTX_C)) {
	...
	protected ModelAndView handleRenderRequestInternal(RenderRequest request,
		...
		if (this.deleted==true) {
			...
			mav.addObject(Constants.ATT_PM, RolePerm.valueOf(this.pm.getRoleInCtx(category.getCategoryId(), NewsConstants.CTX_C)).getMask());
			return mav;
		}
