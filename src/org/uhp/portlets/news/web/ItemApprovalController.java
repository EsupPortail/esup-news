 ...
 * 4 mai 2012
 */
public class ItemApprovalController extends AbstractController implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		if ((this.im == null) || (this.pm == null)) {
			throw new IllegalArgumentException("A itemManager and a Permissionmanager are required");
		}
	}
	...
	public void handleActionRequestInternal(ActionRequest request, ActionResponse response) throws Exception {
		...
		if (!this.pm.canValidateItem(this.im.getItemById(itemId))) {
