...
public class ItemDeleteController extends AbstractController implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        if ((this.im == null) || (this.pm == null) || (this.cm == null) || (this.am == null))
            throw new IllegalArgumentException("An ItemManager, a PermissionManager, a Categorymanager and a userManager are required");
    }
