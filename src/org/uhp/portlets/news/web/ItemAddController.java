...
public class ItemAddController extends AbstractWizardFormController implements InitializingBean {
    private static final Log log = LogFactory.getLog(ItemAddController.class);
    ...
    throws Exception {
                ...
                long pkey = this.im.addItem(itemForm, request.getRemoteUser());
                                ...
                                if (page == 1) {
                                        ...
                                        if (attachmentIds != null) {
                                            for (String id : attachmentIds) {
                                                org.cmis.portlets.news.domain.Attachment attachment = am.getAttachmentById(Long.parseLong(id));
